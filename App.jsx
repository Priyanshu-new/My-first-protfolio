...
import { Download, X, ExternalLink, Code, Mail, Phone, MapPin, Github, Linkedin, GraduationCap, Users, FileWarning } from 'lucide-react';
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 reorganize_contact_info text-sm text-gray-400 space-y-2 font-mono">
              ...
              <div className="flex items-center gap-2"><Mail size={16} className="text-teal-400"/> Email: <a href="mailto:priyanshukesharwani.offical@gmail.com" className="text-sky-400 hover:underline">priyanshukesharwani.offical@gmail.com</a></div>
               <div className="flex items-center gap-2"><Linkedin size={16} className="text-teal-400"/> Link: <a href="https://www.linkedin.com/in/priyanshu-keshrawani-7114b1322?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="text-sky-400 hover:underline">/in/priyanshu-keshrawani-7</a></div>
...
`}</pre>
        ...
        <section id="projects" className="mt-16 pt-8 border-t border-sky-800/30">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ProjectCard
                ...
                description="Developed an assistive platform for speech & hearing‑impaired users. Built a fully responsive UI ensuring accessibility compliance. Improved navigation & engagement metrics."
        ...
        {/* EDUCATION */}
        <section id="education" className="mt-16 pt-8 border-t border-sky-800/30">
          <h3 className="text-3xl font-semibold text-white font-mono mb-6">/ Education</h3>
          <div className="p-6 rounded-lg bg-[#040810] border border-sky-900/50 shadow-md flex items-start gap-4">
            <GraduationCap size={24} className="text-sky-400 flex-shrink-0 mt-1" />
            <div className="font-mono">
                <div className="font-semibold text-white text-lg">B.Tech in Artificial Intelligence & Data Science</div>
                <div className="text-xs text-gray-400 mt-1">Sagar Institute of Science & Technology // Bhopal, India (2024 – 2028 Expected)</div>
                <div className="mt-3 text-sm text-gray-300">Focus: Data Structures, Algorithms, OOP, DBMS, Deep Learning Architectures.</div>
            </div>
          </div>
        </section>
      </main>
          ...
          <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 font-mono">
              ...
              <div>
                  ...
                  <ul className="space-y-2 text-sm">
                      ...
                      <li><a href="#education" className="text-gray-400 hover:text-sky-400 transition duration-200">/education</a></li>
                      <li>
                        <button 
                          onClick={() => setShowResumeModal(true)} 
              ...
              <div>
                  ...
                  <div className="text-sm text-gray-300 space-y-3">
                      ...
                      <ContactLink icon={<Linkedin size={18} />} label="LinkedIn" value="/priyanshu-keshrawani-7" href="https://www.linkedin.com/in/priyanshu-keshrawani-7114b1322?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" />
                  </div>
              </div>
          </div>
